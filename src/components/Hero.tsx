...
export function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-[#0E1116] to-[#1C1F24] pt-24">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center">
        ...
        >
          <motion.h1
            className="text-white mb-5 sm:mb-6 px-2 text-5xl sm:text-6xl md:text-7xl font-bold tracking-tight leading-tight"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.p
            className="text-[#F5F5F7]/80 max-w-2xl mx-auto mb-8 sm:mb-10 px-4 text-lg sm:text-xl leading-relaxed"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <motion.div whileHover={{ scale: 1.05, y: -2 }} whileTap={{ scale: 0.98 }} className="w-full sm:w-auto">
              <Button 
                size="lg" 
                className="w-full sm:w-auto min-h-[54px] px-7 bg-[#F26B2D] hover:bg-[#FF8E3C] text-white group relative overflow-hidden shadow-lg shadow-[#F26B2D]/20"
              >
            ...
            <motion.div whileHover={{ scale: 1.05, y: -2 }} whileTap={{ scale: 0.98 }} className="w-full sm:w-auto">
              <Button 
                ...
                className="w-full sm:w-auto min-h-[54px] px-7 border-[#F5F5F7]/30 !text-white hover:bg-[#F5F5F7]/10 hover:!text-white hover:border-[#F26B2D]/50 backdrop-blur-sm"
              >
